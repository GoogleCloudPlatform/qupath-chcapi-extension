...
/**
 * SeriesPathBuilder builds a path to access the Series in the specified Project, Location, Dataset,
 * DICOM Store and Study. If Study is null, then the path will be built for all Series in the
 * specified Project, Location, Dataset, and DICOM Store.
 */
public class SeriesPathBuilder implements PathBuilder {
  ...
  /**
   * Instantiates a new Series path builder.
   *
