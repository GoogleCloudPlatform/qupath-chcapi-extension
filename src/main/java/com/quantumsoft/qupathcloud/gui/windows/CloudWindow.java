...
import static com.quantumsoft.qupathcloud.gui.panels.Position.*;
...
public class CloudWindow {
    ...
    public CloudWindow(QuPathGUI qupath){
        dicomStoreConfiguration = new DicomStoreConfiguration(qupath.getCurrentProjectDirectory());
    ...
    private void showDatasetsPage(List<Location> locations) {
        ...
        newDatasetButton.setOnAction(event -> {
            showNewDatasetPage(locations);
        });
    ...
    private void showDicomStoresPage() {
        ...
        okButton.setOnAction(event -> {
            DicomStore selectedDicomStore = (DicomStore) currentTable.getSelectionModel().getSelectedItem();
        ...
        newDicomStoreButton.setOnAction(event -> {
            showNewDicomStorePage();
        });
