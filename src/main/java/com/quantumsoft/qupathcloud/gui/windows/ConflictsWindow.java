...
/**
 * If DICOM Store contains different versions of annotations for the same images, user will be
 * presented ConflictsWindow with conflict list and asked to resolve them (with defaults set based
