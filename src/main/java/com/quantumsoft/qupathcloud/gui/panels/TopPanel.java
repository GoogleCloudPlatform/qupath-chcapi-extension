...
public class TopPanel {
  ...
  private static final String svgPathContent = "M340 402.286q0-7.429-5.714-13.143l-266.286-266.28"
      + "6q-5.714-5.714-13.143-5.714t-13.143 5.714l-28.571 28.571q-5.714 5.714-5.714 13.143t5.714"
  ...
  private SVGGlyph getAngleRightGlyph() {
    SVGGlyph angleRightGlyph = new SVGGlyph(1, "angle-right", svgPathContent, Color.BLACK);
